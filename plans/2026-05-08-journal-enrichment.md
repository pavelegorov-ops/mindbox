...
> **Статус: выполнено 2026-07-06.** Слои A/B/C реализованы; первый
> полный прогон обеих секций сделан на OpenAI `gpt-4o-mini`
> (941 статья, 0 ошибок). Детали и стоимость — в
> `plans/2026-07-06-external-agents-audit-fixes.md`, раздел «Пункт 2».
> Добавлен OpenAI-бэкенд к описанному здесь Anthropic-клиенту
> (переключатель `MINDBOX_LLM_PROVIDER`).
