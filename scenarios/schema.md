...
| `dependencies` | да | map | Объявляются для обратного индекса. Все 13 категорий обязательны как ключи (можно пустыми списками). См. раздел `dependencies` ниже — там полный список. |
