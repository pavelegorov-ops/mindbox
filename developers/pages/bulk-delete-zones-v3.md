---
title: Массовое удаление зон
slug: "bulk-delete-zones-v3"
...
```
POST https://api.mindbox.ru/v3/operations/bulk?endpointId={уникальный идентификатор сайта и т.п.}&operation=DirectCrm.Areas.Delete&csvCodePage=65001&transactionId={Значение ключа идемпотентности в формате GUID}
...
- ключ авторизации - это строка вида `username:password`, закодированная в `base64`.
...
```
POST https://api.mindbox.ru/v3/operations/bulk?endpointId={уникальный идентификатор сайта и т.п.}&operation=DirectCrm.Areas.Delete&csvCodePage=65001
